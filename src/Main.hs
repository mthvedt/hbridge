...
main = do
    ...
    putStrLn $ show $ dds
    putStrLn $ show $ playACard dds
    putStrLn $ show $ playACard $ playACard dds
    putStrLn $ show $ playACard $ playACard $ playACard dds
    putStrLn $ show $ playACard $ playACard $ playACard $ playACard dds
    where playACard x = S.playCardS x . head $ S.candidatePlays x
